...
from gx52.driver.x52_driver import X52LedStatus, X52ColoredLedStatus, X52_BRIGHTNESS_MAX, X52DateFormat
...
class X52ProProfile(Model):
    ...
    led_a = EnumField(default=X52ColoredLedStatus.GREEN, choices=X52ColoredLedStatus)
    led_b = EnumField(default=X52ColoredLedStatus.GREEN, choices=X52ColoredLedStatus)
    led_d = EnumField(default=X52ColoredLedStatus.GREEN, choices=X52ColoredLedStatus)
    led_e = EnumField(default=X52ColoredLedStatus.GREEN, choices=X52ColoredLedStatus)
    led_t1_t2 = EnumField(default=X52ColoredLedStatus.GREEN, choices=X52ColoredLedStatus)
    led_t3_t4 = EnumField(default=X52ColoredLedStatus.GREEN, choices=X52ColoredLedStatus)
    led_t5_t6 = EnumField(default=X52ColoredLedStatus.GREEN, choices=X52ColoredLedStatus)
    led_pov_2 = EnumField(default=X52ColoredLedStatus.GREEN, choices=X52ColoredLedStatus)
    led_i = EnumField(default=X52ColoredLedStatus.GREEN, choices=X52ColoredLedStatus)
