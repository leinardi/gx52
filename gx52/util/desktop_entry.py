...
from gx52.conf import DESKTOP_ENTRY, APP_ICON_NAME, APP_DESKTOP_ENTRY_NAME, APP_PACKAGE_NAME
from gx52.util.desktop.desktop_parser import DesktopParser
from gx52.util.path import get_data_path
